...
import { FaPlay, IoMdAdd } from "@/components/icons/Icons.jsx";
    ...
    <div className={styles.container}>                     
        <div className={styles.containerBorder} data-item="withhover-white5">             
            <div className={styles.content}> 
               <img src="https://image.tmdb.org/t/p/original/wXWnUhdnSuADRp9w7aAZNHx682v.jpg" alt="Imagem"/>   
            ...
            <div className={styles.containerButtons}>
                <button className={styles.watchButton} data-item="with-hover" data-color="black-.3">
                    <FaPlay />
                    Assistir
